...
import com.example.albums.service.impl.AlbumServiceImpl;
...
public class AlbumControllerTests {
    ...
    public void testGetAlbums() throws Exception {
        given(albumService.getAlbums(anyInt())).willReturn(
    ...
    public void testAddAlbumToList_Success() throws Exception {
        ...
        given(albumService.addAlbumToList(listId, albumId))
    ...
    public void testAddAlbumToList_WhenListNotFound_ThrowsResourceNotFoundException() throws Exception {
        given(albumService.addAlbumToList(any(UUID.class), any(UUID.class)))
                .willThrow(new ResourceNotFoundException("List not found"));

        MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders
                .post("/albums/add/{listId}/{albumId}", UUID.randomUUID(), UUID.randomUUID())
                .contentType(MediaType.APPLICATION_JSON);
    ...
    public void testRemoveAlbumFromList_Success() throws Exception {
        given(albumService.removeAlbumFromList(any(UUID.class), any(UUID.class)))
                .willReturn(new MessageDto("Album removed from list."));

        MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders
                .delete("/albums/remove/{listId}/{albumId}", UUID.randomUUID(), UUID.randomUUID())
                .contentType(MediaType.APPLICATION_JSON);
