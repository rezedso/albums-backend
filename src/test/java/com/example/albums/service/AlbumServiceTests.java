...
public class AlbumServiceTests {
    ...
    void testAddAlbumToList_Success() {
        ...
        MessageDto result = albumService.addAlbumToList(albumList2.getId(), album2.getId());
    ...
    void testAddAlbumToList_WhenAlbumNotFound_ThrowsResourceNotFoundException() {
        ...
        assertThrows(ResourceNotFoundException.class, ()->
                albumService.addAlbumToList(albumList2.getId(), album2.getId()));
    ...
    void testRemoveAlbumFromList_Success() {
        ...
        MessageDto result = albumService.removeAlbumFromList(albumList2.getId(), album3.getId());
    ...
    void testRemoveAlbumFromList_WhenAlbumNotFound_ThrowsResourceNotFoundException() {
        ...
        assertThrows(ResourceNotFoundException.class, ()->
                albumService.removeAlbumFromList(albumList1.getId(), album1.getId()));
